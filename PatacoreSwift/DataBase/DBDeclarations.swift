...
struct DBDeclarations{
    ...
    init (){
        ...
        CREATE_TABLE_ORDER = "CREATE TABLE IF NOT EXISTS \(TABLE_ORDER) ( \(COLUMN_ORDER_TABLE) INTEGER, \(COLUMN_ORDER_PRODUCT) INTEGER,  \(COLUMN_ORDER_ANNOTATION) TEXT, \(COLUMN_ORDER_QUANTITY) INTEGER, \(COLUMN_ORDER_DATE) TEXT, \(COLUMN_ORDER_HOUR) TEXT);"
