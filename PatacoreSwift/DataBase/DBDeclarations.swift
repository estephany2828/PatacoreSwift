...
struct DBDeclarations{
    ...
    init (){
        ...
        "(\(COLUMN_PRODUCT_ID) INTEGER PRIMARY KEY AUTOINCREMENT, \(COLUMN_PRODUCT_NAME) VARCHAR, \(COLUMN_PRODUCT_PRICE) VARCHAR, \(COLUMN_PRODUCT_DESCRIPTION) VARCHAR)\(COLUMN_PRODUCT_IMAGE) VARCHAR;"
